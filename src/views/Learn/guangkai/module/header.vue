<template>
  <div class="search-container">
    <!-- 搜索 -->
        <el-input v-model="formInline.Founder" style="width: 150px;" size="mini" clearable placeholder="创建人" />
        <el-select v-model="formInline.TuitionFeeSoure" clearable placeholder="==请选择学费情况==" style="width:190px" size="mini">
