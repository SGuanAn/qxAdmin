    ...
    <div class="head-container">
        ...
        <el-table ref="tableData" tooltip-effect="dark" :data="tableData" border v-loading="listLoading" style="margin-top:30px;" @selection-change="handleSelectionChange" >
            ...
            <el-table-column align="center" label="操作" width="200px;">
                <template slot-scope="scope">
                    <see v-permission="['ADMIN', 'NEWDATA_SEE']" :data="scope.row" :sup_this="sup_this" />
                    <edit v-permission="['ADMIN', 'NEWDATA_EDIT']" :data="scope.row" :sup_this="sup_this" />
                </template>
            </el-table-column>
        </el-table>
        <!-- 分页 -->
...
import { getList } from '@/api/Receive'
